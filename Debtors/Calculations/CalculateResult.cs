...
{
    internal class CalculateResult : ICalculateResult
    {
        public void GetCalculatedResult(BarsDataStorage barsData)
        {
            ...
            foreach (var externalKey in dictionary.Keys)
            {
                foreach (var internalKey in dictionary[externalKey].Keys)
                {
                    ...
                    {
                        var firstNameValue = dictionary[externalKey][internalKey]; // Gena
                        var secondNameValue = dictionary[internalKey][externalKey]; // Dima

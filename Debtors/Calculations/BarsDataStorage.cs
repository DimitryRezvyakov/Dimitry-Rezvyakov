...
namespace Debtors.Calculations
{
    ...
    {
        public Dictionary<string, Dictionary<string, int>> BarsData = new Dictionary<string, Dictionary<string, int>>();
        ...
        public void AddBar(PartyData partyData)
        {
            if (BarsData.ContainsKey(partyData.Payer))
            {
                ...
                BarsData[partyData.Payer] = new Dictionary<string, int>(partyData.Names);
        }
    }
}
